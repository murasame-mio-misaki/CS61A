...
def boar_brawl(player_score, opponent_score):
    ...
    if (opponent_score > 100):
        opponent_score%=100
    ans = abs(3*(opponent_score//10-player_score%10)) 
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    max_average_score = averaged(10,dice)
    index = 10
    for i in range(10,0,-1):
        tmp = averaged(i,dice)
        (max_average_score , index)= (max_average_score, index) if max_average_score > tmp else (tmp, i) 

...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(signature):
        ...
        check_formals = formals = signature.rest
        while check_formals != nil:
            if not scheme_symbolp(check_formals.first):
                raise SchemeError('What a dick!')
            check_formals = check_formals.rest
        expr = expressions.rest

        env.define(function_name, LambdaProcedure(formals, expr ,env))
...
def make_let_frame(bindings, env):
    ...
    while bindings != nil:
        ...
        #print(names)
        #print(item.rest, type(item.rest))

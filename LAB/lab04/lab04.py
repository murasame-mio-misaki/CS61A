...
def closer_city(lat, lon, city_a, city_b):
    ...
    if change_abstraction.changed:
         city_current = {'name':'city_cur', 'lat': lat, 'lon': lon}
    else:
        city_current = ['city_cur', lat, lon]
    return get_name(city_a) if distance(city_current, city_a) < distance(city_current, city_b) else get_name(city_b)
